@combined-workflow
Feature: Combined Patient Order Workflow
  As a healthcare provider
  I want to create a complete patient order workflow
  So that I can create patients, orders, and add products in one complete flow

  Scenario: Complete workflow - Create patient, order, and add products
    # ========== E2E PATIENT ORDER CREATION ==========
    # Login Flow
    ...
    # Verify we're still on patient details page with order
